...
int main()
{
    ...
    if (core != NULL)
    {
        ...
        std::sr1::shared_ptr<BoxCollider> catCollider = catEntity->AddComponent<BoxCollider>(glm::vec3(1.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f), false);
  ...
  //      catMusic->SetAutoRemove(true);
        ...
        std::sr1::shared_ptr<Shader> guiShader = core->AddResource<Shader>("../shared/shaders/GUI.txt");
        std::sr1::shared_ptr<Texture> guiTexture = core->AddResource<Texture>("../shared/textures/test.png");
